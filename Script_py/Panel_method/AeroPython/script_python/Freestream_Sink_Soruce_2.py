...
# superposition of the source on the freestream, metodo SDE
...
pyplot.scatter(x_stagnation, y_stagnation, color='g', s=80, marker='o')     # punto di ristagno
...
# SOURCE-SINK IN UNA CORRENTE UNIFORME, Sempre con metodo sovrapposizione degl effetti
...
## Save the figure
saveFlnm = 'freestream_sink_source'
savePth = '/home/luigi/Progetti_Aerodiamica_git/Panel_method_1/AeroPython/script_python/plot/' + saveFlnm + '.JPG'
pyplot.savefig(savePth,bbox_inches='tight',facecolor='w',edgecolor='w')
...
## Save the figure
saveFlnm = 'freestream_sink_source_cp'
savePth = '/home/luigi/Progetti_Aerodiamica_git/Panel_method_1/AeroPython/script_python/plot/' + saveFlnm + '.JPG'
pyplot.savefig(savePth,bbox_inches='tight',facecolor='w',edgecolor='w')